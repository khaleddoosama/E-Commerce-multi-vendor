...
class BrandTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('brands')->insert([
            'brand_name' => 'Apple',
            'brand_slug' => 'apple',
            'brand_image' => 'upload/brand/apple.jpg',
        ]);
        DB::table('brands')->insert([
            'brand_name' => 'Samsung',
            'brand_slug' => 'samsung',
            'brand_image' => 'upload/brand/samsung.jpg',
        ]);
        DB::table('brands')->insert([
            'brand_name' => 'Xiaomi',
            'brand_slug' => 'xiaomi',
            'brand_image' => 'upload/brand/xiaomi.jpg',
        ]);
        DB::table('brands')->insert([
            'brand_name' => 'Huawei',
            'brand_slug' => 'huawei',
            'brand_image' => 'upload/brand/huawei.jpg',
        ]);
        DB::table('brands')->insert([
            'brand_name' => 'Oppo',
            'brand_slug' => 'oppo',
            'brand_image' => 'upload/brand/oppo.jpg',
        ]);
        DB::table('brands')->insert([
            'brand_name' => 'Vivo',
            'brand_slug' => 'vivo',
            'brand_image' => 'upload/brand/vivo.jpg',
        ]);
        DB::table('brands')->insert([
            'brand_name' => 'Realme',
            'brand_slug' => 'realme',
            'brand_image' => 'upload/brand/realme.jpg',
        ]);
        DB::table('brands')->insert([
            'brand_name' => 'Nokia',
            'brand_slug' => 'nokia',
            'brand_image' => 'upload/brand/nokia.jpg',
        ]);
        DB::table('brands')->insert([
            'brand_name' => 'Sony',
            'brand_slug' => 'sony',
