...
<body>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response.wishlist, function(key, value) {
                        ...
                        <td class="pt-40 image product-thumbnail"><img src="/${value.product.product_thambnail}" alt="#" /></td>
    ...
    <td class="row_img"><img src="/${value.product.product_thambnail} " style="width:300px; height:300px;"  alt="compare-img" /></td>
            ...
            <tr class="pr_remove text-muted">
                ...
                <td class="row_remove">
                    <a type="submit" class="text-muted"  id="${value.id}" onclick="compareRemove(this.id)"><i class="mr-5 fi-rs-trash"></i><span>Remove</span> </a>
                </td>
