                ...
                <form method="post" action="{{ route('shop.filter') }}">
                    ...
                    <div class="price-filter">
                        <div class="price-filter-inner">
                            ...
                            <button type="submit" class="btn btn-sm btn-default"><i class="mr-5 fi-rs-filter"></i>
                                Fillter</button>
                        </div>
                    </div>
                    ...
                    <a href="shop-grid-right.html" class="btn btn-sm btn-default"><i class="mr-5 fi-rs-filter"></i>
                        Fillter</a>
            </div>
                ...
                @foreach ($newProduct as $product)
                    <div class="clearfix single-post">
                        ...
                        <div class="pt-10 content">
                            ...
                            @if ($product->discount_price == null)
                                <p class="mt-5 mb-0 price">${{ $product->selling_price }}</p>
                            @else
                                <p class="mt-5 mb-0 price">${{ $product->discount_price }}</p>
                            @endif
