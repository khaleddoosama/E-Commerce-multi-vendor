                    ...
                    <div class="header-action-right">
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <a href="{{ route('compare') }}"><span class="ml-0 lable">Compare</span></a>
                            </div>
                            ...
                            <div class="header-action-icon-2">
                                ...
                                @auth
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                        <ul>
                                            <li>
                                                <a href="{{ route('dashboard') }}"><i class="mr-10 fi fi-rs-user"></i>My
                                                    Account</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('dashboard') }}"><i
                                                        class="mr-10 fi fi-rs-location-alt"></i>Order Tracking</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="{{ route('dashboard') }}"><i class="mr-10 fi fi-rs-heart"></i>My
                                                    Wishlist</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('dashboard') }}"><i
                                                        class="mr-10 fi fi-rs-settings-sliders"></i>Setting</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('user.logout') }}"><i
                                                        class="mr-10 fi fi-rs-sign-out"></i>Sign out</a>
                                            </li>
                                        </ul>
                                    </div>
                                @else
                                    ...
                                    <a href="{{ route('register') }}"><span class="ml-0 lable">Register</span></a>
